...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        else return Double.valueOf(this.y - that.y) / (this.x - that.x);
    }
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        // Point base_point = new Point(0, 0);
        // Point test_point = new Point(2, 5);
        // System.out.printf("Comparison: %d\n", base_point.compareTo(test_point));
        // System.out.printf("Slope: %f\n", base_point.slopeTo(test_point));
    }
}
